...
function ProductDetail(props) {
            ...
            return (
                    ...
                    >
                        <Space>
                            ...
                            <Button disabled={disabled} shape='round' type="primary" htmlType="submit">
                            Mua ngay
                            </Button>
                        </Space>
                    </Form.Item>
    ...
    const mapClassify = classify.map((value,key)=>{
        ...
        if(value.classifyquantity >0){
            ...
            return(
                <Radio.Button disabled >{value.classifyname}-Hết hàng</Radio.Button>
            )
        }
    })
        ...
        if(reviews.length >0){
            return(
                ...
                <Row key={key} style={{margin:4,padding: 8,background:"#f7faff",borderRadius: 6}}>
                    ...
                    <Col span={24}>
                        <Rate disabled value={item.rateStar} />
                    </Col>
                    <Col span={24}>
                        <p>{item.reviewText}</p>
                    </Col>
                    ...
                    <Col xl={{span: 11,push: 1}} style={{paddingLeft: "10px"}}>
                        ...
                        <Row>
                            ...
                            <Form
                                ...
                                >
                                    <InputNumber min={1} max={selectedQuantity} />
                                </Form.Item>
                                {checkIsLogin()}
                                </Form>
                        </Row>
